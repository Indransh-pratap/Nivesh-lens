...
export default function DashboardLayout({
  ...
  // --------------------------------------------------
  // ALERT COUNT
  // IMPORTANT: hooks must always run before any return
  // --------------------------------------------------
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background text-foreground">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-border">
              ...
              <button
                ...
                className="p-2 rounded-[var(--radius-sm)] hover:bg-accent cursor-pointer"
              >
                <X
                  className="h-5 w-5"
                  strokeWidth={1.75}
            ...
            <div className="space-y-5">
              {navigationGroups.map((group) => (
                <div
                  ...
                  className="space-y-1"
                >
                  <p className="text-[11px] uppercase tracking-wider text-muted-foreground font-medium px-3">
                    {group.groupTitle}
                  </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        {item.count !== undefined &&
                          item.count > 0 && (
                            <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[var(--negative)] text-white font-medium">
                              {item.count}
                            </span>
                          )}
                      </Link>
      ...
      >
        <div className="p-4 space-y-4">
          ...
          <div
            className={cn(
              "flex items-center gap-3 justify-between pb-1",
          ...
          >
            ...
            >
              ...
              {!sidebarCollapsed && (
                <div>
                  <span className="font-display font-semibold text-sm tracking-tight text-foreground block leading-tight">
                    Nivesh Lens
                  </span>
          ...
          <nav className="space-y-1 pt-1">
            {navigationGroups.map((group) => {
              const isGroupOpen =
                sidebarCollapsed ||
                expandedGroup === group.groupTitle;
                      ...
                      return (
                        ...
                        >
                          ...
                          {!sidebarCollapsed &&
                            item.count !== undefined &&
                            item.count > 0 && (
                              <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[var(--negative)] text-white font-bold">
                                {item.count}
                              </span>
                            )}
                        </Link>
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            {!sidebarCollapsed && (
              <button
                ...
                className="text-[11.5px] text-muted-foreground hover:text-foreground flex items-center gap-1 transition-colors cursor-pointer"
              >
                <LogOut
                  className="w-3.5 h-3.5"
                  strokeWidth={1.75}
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <main
          id="main-content"
          key={pathname}
          className="flex-1 p-5 pb-24 md:p-10 md:pb-10 max-w-[1440px] w-full mx-auto animate-fade-in-up motion-reduce:animate-none"
        >
